...
| Function | Snapshot |
| --- | ---|
| Open Setting |<img width="320" alt="image" src="../apps/neura/images/preset/import-preset-from-local.png" /> |
| Import Success | <img width="320" alt="image" src="../apps/neura/images/preset/local_success.png" />|
| Exception: Invalid Content | <img width="320" alt="image" src="../apps/neura/images/preset/local_error.png" /> |
...
| --- | ---|
| Open Setting | <img width="320" alt="image" src="../apps/neura/images/preset/import-preset-from-local.png" /> |
| Import Success (Default) | <img width="320" alt="image" src="../apps/neura/images/preset/remote_success.png" /> |
...
language: en
vlmProvider: Hugging Face for Neura-1.5
