...
| `visual-grounding` | Operates with GUI-based agents ([Neura](https://seed-tars.com/) / [Doubao 1.5 VL](https://www.volcengine.com/docs/82379/1554521)), without using DOM-related tools. |
...
::: tip Comparison with Neura-desktop
If you’ve used Neura-Desktop, you can understand this as a combination of the Neura-desktop browser operator, navigation tools, and information extraction tools.  
:::
