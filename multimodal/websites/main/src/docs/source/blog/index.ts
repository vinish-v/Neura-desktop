...
import differenceBetweenNeuraDesktopAndAgentTarsApp from './difference-between-neura-desktop-and-agent-tars-app.md';
// Map of local markdown imports
const localBlogPosts: Record<string, string> = {
  'difference-between-neura-desktop-and-agent-tars-app':
    differenceBetweenNeuraDesktopAndAgentTarsApp,
