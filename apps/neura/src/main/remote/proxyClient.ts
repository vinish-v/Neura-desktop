...
export class ProxyClient {
  ...
  public static async getRemoteVLMProvider(): Promise<NeuraModelVersion> {
    try {
      const res = await this.instance.getRemoteVLMProvider();
      let modelVer = NeuraModelVersion.DOUBAO_1_5_20B;
      switch (res) {
        case 'Neura-1.5':
          modelVer = NeuraModelVersion.V1_5;
          break;
        case 'Neura-1.0':
          modelVer = NeuraModelVersion.V1_0;
          break;
        case 'Doubao-1.5-Neura':
          modelVer = NeuraModelVersion.DOUBAO_1_5_15B;
          break;
        case 'Doubao-1.5-thinking-vision-pro':
          modelVer = NeuraModelVersion.DOUBAO_1_5_20B;
          break;
        default:
          modelVer = NeuraModelVersion.DOUBAO_1_5_20B;
      }
