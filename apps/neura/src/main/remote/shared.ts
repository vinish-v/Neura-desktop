...
const NEURA_PROXY_HOST = '';

const VER = '/api/v1';
const REGISTER_URL = `${NEURA_PROXY_HOST}${VER}/register`;
const PROXY_URL = `${NEURA_PROXY_HOST}${VER}/proxy`;
const BROWSER_URL = `${NEURA_PROXY_HOST}${VER}/browsers`;
const TIME_URL = `${NEURA_PROXY_HOST}${VER}/time-balance`;
const FREE_MODEL_BASE_URL = `${NEURA_PROXY_HOST}${VER}`;
