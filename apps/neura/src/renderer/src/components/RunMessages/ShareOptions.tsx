...
import { ComputerUseUserData, StatusEnum } from '@neura-desktop/shared/types';
    ...
    try {
      ...
      if (type === 'video') {
        ...
        const response = await fetch(
          'https://lf3-static.bytednsdoc.com/obj/eden-cn/eojfrzeh7vhouloj/ai_labs/neura_desktop/share/v011/index.html',
        );
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <b>Neura</b>? This includes your screen recordings and actions.
              <br />
              <br />
