...
import { ConnectorSettings } from './category/connectors';
import { MultimodalSettings } from './category/multimodal';
        ...
        <Tabs defaultValue="vlm" className="w-full gap-6 flex-row">
          ...
          <div className="flex-1">
            ...
            <TabsContent value="multimodal" className="mt-0">
              <ScrollArea className="h-[calc(80vh-48px)]">
                <h2 className="text-xl font-semibold mb-3">Multimodal</h2>
                <Separator className="mb-4" />
                <MultimodalSettings />
              </ScrollArea>
            </TabsContent>
