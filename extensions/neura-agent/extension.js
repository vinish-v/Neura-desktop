...
function activate(context) {
  ...
  context.subscriptions.push(
    ...
    vscode.commands.registerCommand('neura.openMissionControl', wrap(() => provider.openMissionControl())),
    vscode.commands.registerCommand('neura.configureProviders', wrap(() => provider.configureProviders())),
    ...
    vscode.commands.registerCommand('neura.shipApp', wrap(() => inputAndSend('ship', 'Neura: Ship Production App', 'Describe what Neura should prepare, verify, preview, or deploy for production.'))),
    ...
    vscode.commands.registerCommand('neura.acceptCurrentFileProposal', wrap(() => provider.acceptCurrentFileProposal())),
    vscode.commands.registerCommand('neura.rejectCurrentFileProposal', wrap(() => provider.rejectCurrentFileProposal())),
    vscode.commands.registerCommand('neura.reapplyCurrentFileProposal', wrap(() => provider.reapplyCurrentFileProposal())),
    vscode.commands.registerCommand('neura.openNextPendingEdit', wrap(() => provider.openNextPendingEdit())),
    ...
    vscode.commands.registerCommand('neura.fixWorkspaceProblems', wrap(() => provider.fixWorkspaceProblems())),
