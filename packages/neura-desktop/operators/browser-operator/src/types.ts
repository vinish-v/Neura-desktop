...
import type { ScreenshotOutput, ExecuteParams } from '@neura-desktop/sdk/core';

export { StatusEnum } from '@neura-desktop/sdk';
...
export interface BrowserOperatorOptions {
   ...
   * @deprecated Will be removed when `@neura-desktop/sdk` supports hooks natively
   */
